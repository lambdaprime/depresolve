...
/**
 * A factory for repository system instances that employs Maven Artifact Resolver's built-in service
 * locator infrastructure to wire up the system's components.
 */
public class ManualRepositorySystemFactory {
    private static final Logger LOGGER =
            LoggerFactory.getLogger(ManualRepositorySystemFactory.class);
